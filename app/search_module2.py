...
def generate_answer(user_question: str, relevant_cases: list) -> str:
    ...
    prompt = f"""
        ...
        Отвечай предельно кратко и только на основе предоставленного контекста.  
        Если используешь информацию из контекста, обязательно вставляй ссылки на источники в формате [номер источника].  
